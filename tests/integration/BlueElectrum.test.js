...
describe('BlueElectrum', () => {
  ...
  it('ElectrumClient can test connection', async () => {
    assert.ok(!(await BlueElectrum.testConnection('qogecoin-electrum.gorynich.ml', 444, false)));
    assert.ok(!(await BlueElectrum.testConnection('qogecoin-electrum.gorynich.ml', false, 444)));
    ...
    assert.ok(await BlueElectrum.testConnection('qogecoin-electrum.gorynich.ml', '50001'));
    assert.ok(await BlueElectrum.testConnection('qogecoin-electrum.gorynich.ml', false, 443));
  });
