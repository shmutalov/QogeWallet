...
(see https://github.com/shmutalov/QogeWallet/blob/master/CONTRIBUTING.md)
...
## Does QogeWallet download the Qogecoin Headers? I see no place you call blockchain.block.headers so I'm wondering how do you guys deal with the headers? How can you make sure you follow the correct chain in order to make sure you're spending a confirmed UTXO?

The idea is that by default QW doesn’t use public electrum servers, only
ones hosted by QogeWallet, so they are kinda trusted. And end-user has an
